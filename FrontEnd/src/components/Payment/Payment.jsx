...
const Payment = () => {
    ...
    const paymentMethods = [
        { id: 'cod', name: 'Thanh toán khi nhận hàng', icon: 'fa-money-bill', description: 'Thanh toán khi nhận được hàng tại địa chỉ giao hàng' },
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                // Điều hướng đến trang thanh toán thẻ tín dụng
                if (formData.paymentMethod === 'credit') {
                    navigate(`/credit-card-payment/${response.data.id}`);
                    return;
                }
