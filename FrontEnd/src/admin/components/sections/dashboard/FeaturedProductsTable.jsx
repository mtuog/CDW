...
const FeaturedProductsTable = ({ products, formatCurrency }) => {
  return (
    <div className="featured-products-section">
      ...
      <div className="table-container">
        <table className="featured-products-table">
          <thead>
            <tr>
              <th>Sản phẩm</th>
              <th>Giá</th>
          ...
          <tbody>
            {products.map(product => (
              <tr key={product.id}>
                ...
                <td className="product-wishlist-count">
                  <i className="fa fa-heart" style={{ color: '#e65540', marginRight: '5px' }}></i>
